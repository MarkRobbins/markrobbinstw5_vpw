...
define([],function() {
  ...
  Path.prototype = {
       ...
       * @param {number} x1 The x-coordinate of the upper left corner of the rectangle holding the entire ellipse.
       * @param {number} y1 The y-coordinate of the upper left corner of the rectangle holding the entire ellipse.
       * @param {number} w The width of the ellipse.
       * @param {number} h The height of the ellipse.
       * @param {boolean=} invert Specifies if the ellipse will be inverted.
       */
      addEllipse: function (x1, y1, w, h, invert) {
          var ctx = this._ctx,
              kappa = 0.5522848,
              p = this._transform.transformPoint(x1, y1, w, h),
              x = p[0],
              y = p[1],
  ...
  /**
   * Updates the identicon in the specified canvas element.
