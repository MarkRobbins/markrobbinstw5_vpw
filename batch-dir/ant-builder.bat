...
echo appending to build-log.txt
rem echo %yyyy%%mm%%dd%.%hh%%nn%%ss% ========
set B_ERROR=%ANT_ERROR%
echo ANT_ERROR:%ANT_ERROR%
call %ANT_HOME%\bin\ant.bat -q writehist.text.buildend > nul
echo completing........
if "%ANT_ERROR%"=="0" goto MrNoErr
if "%ANT_ERROR%"=="" goto MrNoErr

if not exist "batch-dir\Snarl_CMD.exe" goto flagfail
batch-dir\Snarl_CMD.exe snShowMessage 10 "Build" "Fail" "%CD%\batch-dir\build-fail.png"
:flagfail

echo ==========================================================================
echo ================== B U I L D   F A I L U R E =============================
echo ==========================================================================
echo ok >build-logs\last-fail.buildstatus
del build-logs\last-ok.buildstatus
goto endd


:MrNoErr
if not exist "batch-dir\Snarl_CMD.exe" goto flagok
echo %CD%
batch-dir\Snarl_CMD.exe snShowMessage 10 "Build" "Ok" "%CD%\batch-dir\build-succeed.png"
:flagok

echo ==========================================================================
echo ================== B U I L D   S U C C E S S F U L =======================
echo ==========================================================================
echo ok >build-logs\last-ok.buildstatus
del build-logs\last-fail.buildstatus
goto endd
